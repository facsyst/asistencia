...
$documentos = $objClie->listarTipoDocumento();
...
if($idventa>0){
    ...
    $cliente = $objClie->consultar($idcliente);
                    ...
                    <div class="col-4">
                        ...
                        <div class="input-group">
                            ...
                            <span class="input-group-append">
                                <button type="button" class="btn btn-warning" onclick="BuscarClienteDocumento()" >
                                    <span class="fas fa-search-location"></span>
                                </button>
                            </span>
                            <span class="input-group-append">
                                <button type="button" class="btn btn-primary" onclick="AbrirFormularioBusqueda()" >
...
<div class="modal fade" id="modalBusquedaCliente">
    <div class="modal-dialog modal-xl">
        ...
        <div class="modal-body" id="divBusquedaCliente">
            asdasdasdasd
        </div>
        <div class="modal-footer justify-content-between">
            <button type="button" class="btn btn-default" data-dismiss="modal">Cerrar</button>
...
function AbrirFormularioBusqueda(){
    $.ajax({
        method: "POST",
        url: "vista/clientes.php",
        data: {
            busqueda : 1 
        }
    }).done(function(resultado){
        $("#divBusquedaCliente").html(resultado);
        $("#modalBusquedaCliente").modal('show');
        $("#modalBusquedaCliente").on('hidden.bs.modal', function(e){
            $("#divBusquedaCliente").html("");
        })        
    });
}

function Seleccionar(idcliente){
    $.ajax({
        method: 'POST',
        url:    'controlador/contCliente.php',
        data:{
