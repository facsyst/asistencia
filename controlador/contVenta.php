    ...
    switch($proceso){
        case "NUEVO":
            try{
                ...
                foreach($carrito as $k=>$v){
                    $producto = $objPro->consultar($v["idproducto"]);
                ...
                if($duplicado->rowCount()==0 && count($problemasStock)==0){
                    ...
                    if($existe->rowCount()>0){
                        ...
                        $objClie->actualizar($cliente['idcliente'], $_POST['nombre'], $_POST['idtipodocumento'], $_POST['nrodocumento'], $_POST['direccion'], $cliente['estado']);
        ...
        case "AGREGAR_PRODUCTO":
            try{
                ...
                $producto = $objPro->consultar($idproducto);
            ...
            case "OBTENER_ITEM":
                try{
                    ...
                    $producto = $objPro->consultar($_SESSION['carrito'][$item]["idproducto"]);
                    $producto = $producto->fetch(PDO::FETCH_NAMED);
